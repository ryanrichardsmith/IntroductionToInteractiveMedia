...
- Something interesting that I discovered when utilizing semicircular arcs was that you can invert them by reversing the order of the start/stop parameters (i.e. radian(180) THEN 0)
